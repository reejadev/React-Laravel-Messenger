...
useEffect(() => {
 ...
 ><div className="fixed inset-0 bg-black/25"></div></TransitionChild>
...
<div className="fixed inset-0 overflow-y-auto">
    <div className="h-screen w-screen">
        ...
        >
            <DialogPanel className="flex flex-col w-full h-full transform overflow-hidden
             bg-slate-800 text-left align-middle shadow-xl transition-all">
                <button onClick={close}
                         className="absolute right-3 top-3 w-10 h-100 rounded-full

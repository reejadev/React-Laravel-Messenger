...
<Modal show={show} onClose={closeModal}>
        ...
        >
            ...
            <div className="mt-8">
                ...
                <InputError className="mt-2" message={errors.name}></InputError>
            </div>
...
<InputError className="mt-2" message={errors.description}></InputError>
                </div>

<div className="mt-4">
    <InputLabel value="Select Users"></InputLabel>
...
<InputError className="mt-2" message={errors.user_ids}></InputError>
